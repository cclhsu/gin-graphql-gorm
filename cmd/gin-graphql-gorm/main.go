...
// go run ./cmd/gin-graphql-gorm/main.go
// swag init -g cmd/gin-graphql-gorm/main.go -o doc/openapi
// go build -o ./bin/gin-graphql-gorm ./cmd/gin-graphql-gorm
// ./bin/gin-graphql-gorm
...
import (
	...
	cache "github.com/cclhsu/gin-graphql-gorm/internal/cache/redis"
	"github.com/cclhsu/gin-graphql-gorm/internal/config"
	"github.com/cclhsu/gin-graphql-gorm/internal/model"
	mongodb_repository "github.com/cclhsu/gin-graphql-gorm/internal/repository/mongodb"
	postgres_repository "github.com/cclhsu/gin-graphql-gorm/internal/repository/postgres_gorm"
	"github.com/cclhsu/gin-graphql-gorm/internal/route"
...
func setupLogger() {
	...
	// hook := logrusly.NewLogglyHook("https://logs-01.loggly.com/inputs/0b0f0f1e-0b0b-4b0b-8b0b-0b0b0b0b0b0b/tag/http/", "gin-graphql-gorm", logrus.InfoLevel)
...
func startGinServer() {
	...
	fmt.Printf("Starting up on http://0.0.0.0:%s/playground/ for GraphQL playground", port)
